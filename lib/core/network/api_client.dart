...
/// (via CustomException + el exception_handler global de FastAPI).
...
/// Unico punto por donde pasa CADA llamada HTTP de la app. Los services
/// de features NUNCA llaman package:http directo - siempre a traves de esto,
/// asi el manejo de token/errores/headers vive en un solo lugar.
class ApiClient {
