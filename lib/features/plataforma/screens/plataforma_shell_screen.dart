      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: ClipRRect(
            ...
            child: Image.asset('assets/icons/icono.webp', width: 36, height: 36, fit: BoxFit.cover),
          ),
        ),
        title: Column(
          ...
          children: [
            Text(
              _titulos[_tab],
              style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 21, letterSpacing: -0.3),
            ),
            if (sesion != null)
              Text(
                sesion.nombre,
